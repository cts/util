...
module.exports = {
  ...
  getTreesheetLinks: function($fromNode) {
    ...
    /*
     * Find Cloudstitch Widgets.
     */
    _.each(find('*[stitch]'), function(elem) {
      var e = $(elem);
      var url = exports.toWidgetUrl(e.attr('stitch'));
      var format = 'string';
      var block = {
        type: 'link',
        url: url,
    ...
    /*
     * Find Cloudstitch Spreadsheet links
     */
  ...
  /*
   * Takes a fragment USERNAME/APPNAME and expands into the 
   * URL of a treesheet. Keeping it simple for now: the treesheet
   * must be named treesheet.cts.
   */
  toWidgetUrl: function(fragment) {
    return '//apps.cloudstitch.io/' + fragment + '/treesheet.cts';
  },
